            ...
            steps{
                script {
                    ...
                    withDockerRegistry(credentialsId: 'docker-creds', toolName: 'docker') {
                        ...
                        sh "docker tag simple-app bhagyashreeramnath.rajpure28@gmail.com/simple-app:latest "
                        sh "docker push bhagyashreeramnath.rajpure28@gmail.com/simple-app:latest "
